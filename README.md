...
- **Test262 language suite: 98.4%**, **built-ins: 72.4%**, **TypeScript 6.0.3 conformance: 70.4%** (see details below)
...
| Test262 built-ins | 16,864/23,294 | 6,430 | 0 | 0 | 72.4% |
| TypeScript 6.0.3 conformance | 3,471/4,933 | 989 | 473 | 0 | 70.4% |
<!-- compliance:end -->
...
At **98.4% Test262 language compliance** and **70.4% TypeScript 6.0.3 conformance**, Paserati handles a large chunk of modern JavaScript/TypeScript semantics correctly. It's still evolving, but it's past the "toy project" phase.
