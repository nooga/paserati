...
- **Test262 language suite: 98.4%**, **built-ins: 72.4%**, **TypeScript 6.0.3 conformance: 70.6%** (see details below)
...
| TypeScript 6.0.3 conformance | 3,485/4,933 | 975 | 473 | 0 | 70.6% |
<!-- compliance:end -->
...
At **98.4% Test262 language compliance** and **70.6% TypeScript 6.0.3 conformance**, Paserati handles a large chunk of modern JavaScript/TypeScript semantics correctly. It's still evolving, but it's past the "toy project" phase.
