...
func TestOperatorsAndLiterals(t *testing.T) {
	testCases := []matrixTestCase{
		...
		{name: "InfixEqNum_F", input: "let x = 10; let y = 5; x == y;", expect: "false"},
		{name: "InfixEqStr_T", input: `"a" == "a";`, expect: "true"},
		{name: "InfixEqStr_F", input: `let x = "a"; let y = "b"; x == y;`, expect: "false"},
		...
		{name: "InfixNeqStr_T", input: `let x = "a"; let y = "b"; x != y;`, expect: "true"},
		...
		{name: "StrictEqNum_F", input: "let x = 10; let y = 5; x === y;", expect: "false"},
		{name: "StrictEqStr_T", input: `"a" === "a";`, expect: "true"},
		{name: "StrictEqStr_F", input: `let x = "a"; let y = "b"; x === y;`, expect: "false"},
		{name: "StrictEqBool_T", input: "true === true;", expect: "true"},
		{name: "StrictEqBool_F", input: "let x = true; let y = false; x === y;", expect: "false"},
		{name: "StrictEqNull_T", input: "null === null;", expect: "true"},
		{name: "StrictEqNull_F", input: "let x = null; let y = false; x === y;", expect: "false"},
		{name: "StrictEqMixType", input: `let x: any = 10; let y: any = "10"; x === y;`, expect: "false"},
		{name: "StrictNeqNum_F", input: "10 !== 10;", expect: "false"},
		{name: "StrictNeqNum_T", input: "let x = 10; let y = 5; x !== y;", expect: "true"},
		{name: "StrictNeqStr_F", input: `"a" !== "a";`, expect: "false"},
		{name: "StrictNeqStr_T", input: `let x = "a"; let y = "b"; x !== y;`, expect: "true"},
		{name: "StrictNeqBool_F", input: "true !== true;", expect: "false"},
		{name: "StrictNeqBool_T", input: "let x = true; let y = false; x !== y;", expect: "true"},
		{name: "StrictNeqNull_F", input: "null !== null;", expect: "false"},
		{name: "StrictNeqNull_T", input: "let x = null; let y = false; x !== y;", expect: "true"},
		{name: "StrictNeqMixType", input: `let x: any = 10; let y: any = "10"; x !== y;`, expect: "true"},
		...
		{name: "CompAssign Coalesce Null", input: "let k: null | number = null; k ??= 10; k;", expect: "10"},
		{name: "CompAssign Coalesce Undefined", input: "let l: number | undefined; l ??= 20; l;", expect: "20"},
